...
export function SecondaryButton({ children, isDisabled = false, onClick, isActive }: SecondaryButtonProps) {
  ...
  return (
    <button
      disabled={isDisabled}
      onClick={onClick}
      className={`w-full py-5 px-5 lg:px-12 border-2 border-primary-blue-base text-primary-blue-base font-bold text-[27px] rounded-[20px] cursor-pointer outline-none
