...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 px-4 py-5 z-50 bg-white">
      <div className="flex justify-between 2xl:max-w-[1440px] mx-auto w-full xl:max-w-[78rem] min-[900px]:max-w-4xl min-[1120px]:max-w-[68rem] items-center">
        {/* LOGO */}
